...
local UserConfig = {
  ...
  s_windows = {
    ...
    keys = {
      ...
      width_decrease = "<C-Left>",
      width_increase = "<C-Right>",
      height_decrease = "<C-Down>",
      height_increase = "<C-Up>",
      size_equal = "s=",
    },
  },
